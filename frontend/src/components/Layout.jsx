...
import { Home, LayoutDashboard, BarChart3, GitCompare, Video, Terminal, Cpu, BrainCircuit, Network, Image, Layers, Database } from 'lucide-react';

const navItems = [
  { to: '/', icon: <Home size={18} />, label: 'Home' },
  { to: '/dashboard', icon: <LayoutDashboard size={18} />, label: 'Dashboard' },
  { to: '/analytics', icon: <BarChart3 size={18} />, label: 'Analytics' },
  { to: '/comparison', icon: <GitCompare size={18} />, label: 'Comparison' },
  { to: '/neural', icon: <BrainCircuit size={18} />, label: 'Neural HUD' },
  { to: '/applications', icon: <Layers size={18} />, label: 'Applications' },
